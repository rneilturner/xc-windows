...
cd /d %2
rem %1\bin\x86\stampinf -f xenevtchn\xevtchn.inf -d %Month%/%Day%/%Year% -v || exit /b 1
rem %1\bin\x86\stampinf -f xenevtchn\xevtchn64.inf -d %Month%/%Day%/%Year% -v || exit /b 1
rem %1\bin\x86\stampinf -f net\xennet.inf -d %Month%/%Day%/%Year% -v || exit /b 1
rem %1\bin\x86\stampinf -f net\xennet64.inf -d %Month%/%Day%/%Year% -v || exit /b 1
rem %1\bin\x86\stampinf -f xenvbd\xenvbd.inf -d %Month%/%Day%/%Year% -v || exit /b 1
rem %1\bin\x86\stampinf -f xenvbd\xenvbd64.inf -d %Month%/%Day%/%Year% -v || exit /b 1
...
%1\bin\x86\stampinf -f xenvesado\xenVesaDO.inf -d %Month%/%Day%/%Year% -v || exit /b 1
